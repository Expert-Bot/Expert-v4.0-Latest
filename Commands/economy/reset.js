    ...
    async execute(interaction) {
        ...
        switch (sub) {
            ...
            ecoSchema.findOne({ Guild: interaction.guild.id, User: user.id}, async (err, data) => {
                ...
                .setFooter({ text: '<a:MTF_Credits:1082731156711149721> Currency Reset Acknowledged'})
                .setTimestamp()
                .setThumbnail('https://media.discordapp.net/attachments/1058833929756479518/1197957603767095407/Asset_9.png?ex=65bd27f5&is=65aab2f5&hm=1dc34bbaae9dae650088f7aa2d43a6909352728039e5437f10fded40eed42528&=&format=webp&quality=lossless&width=676&height=676')
            ...
            ecoSchema.deleteMany({ Guild: interaction.guild.id}, async (err, data) => {
                ...
                .setFooter({ text: '<a:MTF_Credits:1082731156711149721> Economy Global Reset Acknowledged'})
                .setTimestamp()
                .setThumbnail('https://media.discordapp.net/attachments/1058833929756479518/1197957603767095407/Asset_9.png?ex=65bd27f5&is=65aab2f5&hm=1dc34bbaae9dae650088f7aa2d43a6909352728039e5437f10fded40eed42528&=&format=webp&quality=lossless&width=676&height=676')
