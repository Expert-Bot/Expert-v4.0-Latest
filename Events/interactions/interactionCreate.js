...
//vote required
if (command.voteRequired && !["903237169722834954", "804418829065125909"].includes(interaction.user.id)) {
  ...
  if (!hasVoted) {
    ...
    return;
      ...
      if (command.premium && !guild?.isPremium) {
          const embed = new EmbedBuilder()
              ...
              .setTimestamp()
              .setDescription(`It seems like ${interaction.guild.name} is not a premium server.
  To use this command feature, you need to be a premium subscriber. Head over to our [Support Server](https://discord.gg/YCKVADw55t) for a trial of our premium services.`);
